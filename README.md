...
<p align="center">
  <a href="./issues"><img src="https://img.shields.io/github/issues/JappeOS/jappeos_software_center?style=plastic&color=edda09"></a>
  <a href="./pulls"><img src="https://img.shields.io/github/issues-pr/JappeOS/jappeos_software_center?style=plastic&color=40a842"></a>
  <a href="./blob/main/LICENSE"><img src="https://img.shields.io/github/license/JappeOS/jappeos_software_center?style=plastic&color=9d09ed"></a>
...
* Open installed apps
* Search apps from repositories
* System update handling
* Flatpak and Pacman support

## Role in the OS

A system app that allows the user to install and manage software on the system.
...
```bash
$ git clone https://github.com/JappeOS/jappeos_software_center.git
$ cd jappeos_software_center
$ flutter pub get
```
